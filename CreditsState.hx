...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color			
		...
		[''],
		['Contributors'],
		['Keoiki',				'keoiki',			'Unused Psych Note Splash Animations',				'https://twitter.com/Keoiki_',			0xFFFFFFFF],
	...
	override function create()
	{
		...
		//idk how fade in color works
		bgcolor = new FlxSprite().loadGraphic(Paths.image('menubgs/Credit/CreditBG'));
		bgcolor.alpha = 0.5;
		add(bgcolor);
		...
		bgcolor.color = creditsStuff[curSelected][4];
		intendedColor = bgcolor.color;
		changeSelection();
		super.create();
	}
	...
	function changeSelection(change:Int = 0)
	{
		...
		if(newColor != intendedColor) {
			...
			colorTween = FlxTween.color(bgcolor, 1, bgcolor.color, intendedColor, {
